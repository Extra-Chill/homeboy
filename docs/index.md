...
- Start here: [Homeboy CLI: commands and JSON output contract](homeboy-cli-commands-and-json-contract.md)
- Commands: [Commands index](commands/commands-index.md)
- JSON output: [JSON output contract](json-output/json-output-contract.md)
