...
### Fixed
- report the latest attempt on the printed cook id
- reuse admitted component identity in lab staging
...
### Added
- add agent-task capacity for every rotation plan's capacity and reset

## [0.388.2] - 2026-09-24

### Changed
- pin homeboy-action with empty-inventory acceptance

### Fixed
- fix and verify the last 7 red tests on main

## [0.388.1] - 2026-09-24

### Changed
- pin homeboy-action with the retry-checkout subdirectory fix
- fix and quarantine core/agents red tests (homeboy#14984)

### Fixed
- a changed-scope run that selects zero tests is valid evidence
...
### Added
- read locked versions from a dependency adapter's declared lockfile
...
### Fixed
- let a component scripts.build artifact supersede a conflicting extension package
...
### Fixed
- take historical Cook index import off the submission hot path

## [0.385.1] - 2026-09-23

### Fixed
- install without running the readiness probe first

## [0.385.0] - 2026-09-23

### Added
- support project-level and project-scoped post:deploy hooks

## [0.384.1] - 2026-09-23

### Fixed
- admit local-runnable review gates instead of blanket-rejecting review test
- provision credential files for the plan-selected provider route
- accept suffixed issue URLs and unmaterialized worktree handles
...
### Fixed
- preserve runner provider source delivery

## [0.383.14] - 2026-09-22

### Fixed
- stage monorepo components at their subdirectory
...
### Added
- route component env through API v1

## [0.379.0] - 2026-09-20

### Added
- record provider usage accounting

### Fixed
- admit bounded module-scoped Cargo gates
...
### Fixed
- stop memoizing a digest the filesystem clock cannot vouch for
...
### Fixed
- bind candidate reconnect continuation
...
### Fixed
- report durable detached admission
- ensure typed provider misses
- select explicit artifact version targets
...
### Fixed
- honor explicit candidate reconciliation

## [0.348.4] - 2026-08-14

### Fixed
- isolate refresh artifact persistence
- bound refresh output
...
### Fixed
- accept both prose shapes in the AI review form
...
### Changed
- thread recipe store through execution
...
### Fixed
- reuse key-authenticated runner sessions
...
### Fixed
- stabilize stale generation owner selection
- refresh stale control-plane env
- share remote authority snapshot
...
### Added
- add durable managed services

### Fixed
- gate executor root device/inode check to unix
- restore Rust 1.95 warning-clean gate
...
### Fixed
- run the Rust gate single-threaded so env writers cannot race readers
...
### Fixed
- retire the core-boundary policy's self-inflicted noise, see interpreters, derive the policy section
- use GitHub App client IDs
- document the two-layer defaults contract, fail safe on a malformed override
...
### Fixed
- strip conventional prefix with hyphenated/punctuated scopes
...
### Fixed
- scope provenance identity requirement
- downgrade stale-heartbeat running rows from active totals

## [0.310.2] - 2026-07-23

### Fixed
- preserve verified child build identity
...
### Fixed
- warn when advertised fixable findings apply zero edits
...
### Changed
- add AgentTaskArtifact::default() and drop construction boilerplate
...
### Fixed
- fix(agent-task): mark terminal status liveness
...
### Changed
- Support extension deps install plans
...
### Changed
- Honor rig accepted settings during Lab offload
- Bound agent-task provider execution
...
### Changed
- Guard release package artifacts with skip publish
...
### Changed
- Collapse quality gates under review

## [0.281.5] - 2026-07-04

### Changed
- Normalize test failures sidecar parsing
...
- Add typed agent-task workload contract
- Add core compatibility constraints to extension manifests
- Tokenize daemon lifecycle leases
...
### Fixed
- persist lab fanout handoff status
- add lab contract for worktree cleanup
- surface runner workspace prune bytes
- propagate forced worktree cleanup removal
...
### Fixed
- block lab sync under disk pressure
...
### Fixed
- filter local package checks by id before parsing
