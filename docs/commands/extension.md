...
- Optional fields include `ready_reason`, `ready_detail`, `manifest_path`, `error`, `diagnostic`, `symlink_target`, `source_revision`, `cli_tool`, `cli_display_name`, `actions`, `has_setup`, and `has_ready_check`.
