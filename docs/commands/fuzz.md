...
homeboy fuzz stable plan --manifest <path> [--stable-id <id[,id]>] [--runner <id>] [--artifact-root <dir>] [--run-id-prefix <id>] [--tracker-ref <kind:id>] [--wait] [--component <id>] [--since <duration>] [--limit <n>] [--hotspot-limit <n>]
