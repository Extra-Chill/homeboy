...
| Option | Value | Description |
| --- | --- | --- |
| `--request` | `<REQUEST>` | Complete JSON PlacementReadinessRequest emitted as `compiled_request` by a prior readiness response or generated by the execution compiler |
