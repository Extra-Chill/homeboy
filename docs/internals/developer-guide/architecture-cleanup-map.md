...
- `src/cli_surface/mod.rs` owns clap command shape, hidden compatibility aliases, and command-surface introspection.
...
| --- | --- | --- | --- |
| Legacy placement aliases | `src/cli_surface/mod.rs` | Rejected parser inputs with targeted migration errors. | None: product policy is zero legacy placement support. |
