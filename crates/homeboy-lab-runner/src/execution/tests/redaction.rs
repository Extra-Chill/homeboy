use super::*;
use crate::{RunnerResourceGuardViolation, RunnerResourceMetrics};
use serde_json::json;
...
fn runner_exec_redacts_daemon_job_events() {
    ...
    let events = vec![homeboy_core::api_jobs::JobEvent {
        sequence: 1,
        job_id: uuid::Uuid::new_v4(),
        kind: homeboy_core::api_jobs::JobEventKind::Result,
        timestamp_ms: 1,
...
fn runner_exec_failure_error_promotes_homeboy_job_event_message_error() {
    ...
    output.job_events = Some(vec![homeboy_core::api_jobs::JobEvent {
        sequence: 1,
        job_id: uuid::Uuid::new_v4(),
        kind: homeboy_core::api_jobs::JobEventKind::Error,
        timestamp_ms: 1,
        message: Some(
