...
fn accepted_job_that_disappears_persists_a_terminal_controller_failure() {
    homeboy_core::test_support::with_isolated_home(|_| {
        ...
        let records = store
            .list_runs(homeboy_core::observation::RunListFilter {
...
fn detached_handoff_output_includes_runner_job_and_agent_task_followups() {
    homeboy_core::test_support::with_isolated_home(|_| {
        ...
        assert_eq!(
            ...
            homeboy_core::lab_contract::RUNNER_ARTIFACT_MANIFEST_SCHEMA
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            homeboy_core::lab_contract::RUN_LOCATION_INDEX_SCHEMA
        );
...
fn reverse_broker_exec_submits_job_and_polls_result() {
    homeboy_core::test_support::with_isolated_home(|_| {
        ...
        assert!(output
            ...
            .expect("events")
            .iter()
            .any(|event| { event.kind == homeboy_core::api_jobs::JobEventKind::Progress }));
