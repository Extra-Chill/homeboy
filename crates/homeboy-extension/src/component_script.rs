...
impl homeboy_core::component_script_provider::ComponentScriptRunner
    for ExtensionComponentScriptRunner
{
...
pub fn register_component_script_runner() {
    homeboy_core::component_script_provider::register_component_script_runner(Box::new(
