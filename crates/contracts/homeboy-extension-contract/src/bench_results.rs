//! Top-level bench result contract types.
//!
//! The whole bench result graph now lives in leaf crates; these four
//! aggregate types tie it together.
...
use homeboy_lifecycle_contract::LifecycleResultMetadata;

use crate::BenchArtifact;
use crate::BenchDiagnostic;
...
{
    Vec::<HomeboyFinding>::deserialize(deserializer)
}
