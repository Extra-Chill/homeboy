...
pub(crate) fn lab_offload_source_path(args: &[String]) -> Result<PathBuf> {
...
pub(crate) fn rewrite_lab_offload_args(
    args: &[String],
    remote_path: &str,
...
pub(crate) fn rewrite_runner_resident_lab_offload_args(
    args: &[String],
    remote_output_file: Option<&str>,
) -> Vec<String> {
