...
pub mod batch {
    pub use super::super::agent_task_batch::{
        ...
        owned_child_run_ids, persist_fanout_run_batch, read_batch_record,
        record_coordinator_cancellation, record_fanout_run_batch_failed_admissions, status,
...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        record_acceptance_verdict, record_completed_run, record_cook_attempt,
