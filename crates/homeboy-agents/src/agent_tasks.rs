...
pub use super::agent_task_secrets::{
    resolve_secret_env_plan, secret_env_status, secret_env_status_with_fallbacks,
...
pub mod controller_service {
    pub use super::super::agent_task_controller_service::{
        ...
        ControllerDispatchHook, ControllerDispatchOverrides, ControllerEventReport,
        ...
        ControllerPlanRequest, ControllerProofIdentity, ControllerProofPreflightCheck,
        ControllerProofPreparation, ControllerProofProfile, ControllerResumeOptions,
        ControllerResumeReport, MaterializeSpecSource, NoopDispatchHook, ACTION_RESULT_SCHEMA,
...
pub mod lifecycle {
    ...
    pub use super::super::agent_task_lifecycle::{
        ...
        runner_pinned_runtime_for_mutation, runner_probe_plan,
...
pub mod loop_controller {
    pub use crate::agent_task_loop_controller::{
        controller_status, controller_status_diagnostics, controller_status_report,
        create_controller, list_controllers, load_controller, write_controller,
        ...
        AgentTaskLoopFindingPacket, AgentTaskLoopGateStatus, AgentTaskLoopHistoryEvent,
        AgentTaskLoopLocalFallbackPolicy, AgentTaskLoopPendingActionDiagnostic,
        AgentTaskLoopPolicy, AgentTaskLoopPolicyAction, AgentTaskLoopPolicyActionRecord,
        AgentTaskLoopProvenanceRef, AgentTaskLoopReviewFinding, AgentTaskLoopRunRef,
        AgentTaskLoopRunnerAvailability, AgentTaskLoopRunnerExecutionTarget,
...
pub mod provider {
    ...
    pub use crate::agent_task_provider::{
        ...
        provider_secret_env_scopes, provider_secret_sources_for_plan,
...
pub mod service {
    pub use super::super::agent_task_service::{
        adopt_cook_candidate, adopt_cook_candidate_with_options_and_dispatcher,
        ...
        normalize_plan_workspaces, persist_manual_finalization_intent,
        ...
        preflight_continuation_claim_in_store,
        ...
        AgentTaskCookBatchJobRequest, AgentTaskCookBatchOptions, AgentTaskCookBatchReport,
        AgentTaskCookCellError, AgentTaskCookReport, AgentTaskDiscoveryCommands,
        AgentTaskDiscoveryCounts, AgentTaskDiscoveryFilter, AgentTaskDiscoveryReport,
        AgentTaskDiscoveryRun, AgentTaskHydratedEvidence, AgentTaskLiveness, AgentTaskPromotionJob,
        AgentTaskPromotionJobDriver, AgentTaskPromotionJobPhase, AgentTaskPromotionRequest,
        AgentTaskRetryServiceResult, AgentTaskRunResult, CookActivityProbe, CookBasePreparation,
        CookContinuationState, CookMode, CookProgressEvent, CookProviderActivity,
        CookProviderRouteOverride, CookRecipeStore, CookRequest, CookRuntime, CookService,
