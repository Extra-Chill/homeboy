...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        has_accepted_runner_handoff, invalidate_cook_finalization_for_dependency,
        ...
        prune_controller_runtime_pins, quarantine_queued_run_exact, rearm_quarantined_run,
        rearm_unmaterialized_cook_admission, reconcile_record_health,
        reconcile_terminal_artifact_projection, record_acceptance_verdict_with_feedback_in_store,
        ...
        record_lab_offload_phase, record_lab_offload_planned, record_manual_finalization_failure,
        record_manual_finalization_retry, record_pre_dispatch_failure,
        ...
        renew_unmaterialized_cook_replay_claim, require_detached_cook_handoff_fence_open,
        reserve_detached_cook_handoff_materialization,
...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        CookContinuationState, CookProgressEvent, CookProviderActivity, CookSupervisionTick,
