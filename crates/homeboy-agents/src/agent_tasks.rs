...
pub mod lifecycle {
    ...
    pub use super::super::agent_task_lifecycle::{
        ...
        runner_probe_plan, status, status_with_options, submit_plan,
        ...
        LabOffloadProxyPlan, RUNNER_PROBE_SKIPPED_CALLER_OPTED_OUT,
...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        read_plan, rearm_failed_terminal_continuation, reconcile_terminal_artifact_projection,
