...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        adopt_cook_candidate_with_options_dispatcher_and_executor, aggregate_exit_code, artifacts,
        cancel, compile_cook_attempt, discover_runs, evidence_ref_task_id, hydrate_evidence_ref,
        ...
        read_plan, reconcile_terminal_artifact_projection, recover_cook_pr, resume,
        resume_cook_batch, retry, run_cook, run_cook_batch, run_loaded_plan, run_next,
        run_next_with_cook_dispatcher, run_status, run_submitted, run_submitted_with_timeout,
        source_worktree_path, status, submit_plan_spec, validate_initial_recipe_compatibility,
