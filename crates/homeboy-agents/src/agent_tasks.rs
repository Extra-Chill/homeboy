...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        record_cook_force_with_lease_receipt, record_detached_cook_handoff_child,
        record_detached_cook_handoff_parent, record_detached_lab_run, record_health_summary,
        ...
        submit_plan, verified_controller_artifact_projection_path, AgentTaskAcceptanceAttestation,
...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        consume_claimed_with_dispatcher, cook_batch_job_submission, discover_runs,
        ...
        recover_terminal_transport_proxy_evidence, register_cook_batch_job_driver,
        register_promotion_job_driver, resolve_cook_continuation_run_id,
        resolve_supervision_policy, resume, resume_cook, resume_cook_batch, retry, run_cook,
        run_cook_batch, run_cook_batch_with_control, run_cook_with_durable_observer,
        ...
        AgentTaskCookBatchOptions, AgentTaskCookBatchReport, AgentTaskCookReport,
        ...
        AgentTaskRunResult, CookActivityProbe, CookBatchJobDriver, CookProgressEvent,
        CookProviderActivity, CookSupervisionTick, CookSupervisor, AGENT_TASK_COOK_BATCH_JOB_TYPE,
