...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        artifacts, cancel, claim_continuation_for, claim_continuation_for_recovery,
        compile_cook_attempt, consume_claimed_terminal_with_dispatcher,
        ...
        reconcile_terminal_artifact_projection, reconstruct_options_with_dispatcher,
        record_replacement_gate_proof, recover_cook_pr, recover_terminal_transport_proxy_evidence,
        register_promotion_job_driver, resolve_cook_continuation_run_id, resume, resume_cook,
        ...
        submit_plan_spec, terminal_transport_recovery_required,
