...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        artifacts, cancel, claim_continuation_for, compile_cook_attempt,
        consume_claimed_with_dispatcher, discover_runs, enqueue_terminal_continuation,
        evidence_ref_task_id, hydrate_evidence_ref, hydrate_evidence_summary, load_recipe,
        load_recipe_for_attempt, logs, normalize_plan_workspaces, offloaded_status_remediation,
        persist_initial_recipe, persist_provider_boundary_replay_evidence, promotion_source,
        read_plan, reconcile_terminal_artifact_projection, reconstruct_options_with_dispatcher,
        recover_cook_pr, recover_terminal_transport_proxy_evidence, resume, resume_cook_batch,
        retry, run_cook, run_cook_batch, run_cook_with_durable_observer, run_loaded_plan, run_next,
        run_next_with_cook_dispatcher, run_status, run_submitted, run_submitted_with_timeout,
        source_worktree_path, status, submit_plan_spec, terminal_transport_recovery_required,
