...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        exact_durable_local_read, exact_durable_local_read_in_store, exact_record,
        fail_cook_operation, fail_detached_cook_handoff_parent,
        ...
        load_plan_in_store, logs, mark_resuming, mark_running,
