...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        quarantine_queued_run_exact, rearm_quarantined_run, reconcile_record_health,
        reconcile_terminal_artifact_projection, record_acceptance_verdict, record_completed_run,
        record_cook_attempt, record_cook_finalization, record_cook_force_with_lease_receipt,
        ...
        run_record_exists_readonly, run_record_exists_resolved, run_status,
        ...
        AgentTaskAcceptanceAttestation, AgentTaskAcceptanceRecord, AgentTaskAcceptanceRequirement,
        AgentTaskAcceptanceVerdict, AgentTaskAcceptanceVerificationRequest,
        AgentTaskAcceptanceVerifier, AgentTaskAcceptanceVerifierProvenance, AgentTaskArtifactRef,
        AgentTaskCookIndex, AgentTaskCookIndexAttempt, AgentTaskDurableLocalRead,
        AgentTaskDurableReadUnavailable, AgentTaskEventEnvelope, AgentTaskPreDispatchFailure,
...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        artifacts, authorize_cook_continue_route, cancel, claim_continuation_for,
        claim_continuation_for_recovery, compile_cook_attempt,
        ...
        run_cook_with_durable_observer, run_loaded_plan, run_next, run_next_with_cook_dispatcher,
        run_status, run_submitted, run_submitted_with_timeout, run_terminal_cook_continuation,
        source_worktree_path, status, submit_plan_spec,
