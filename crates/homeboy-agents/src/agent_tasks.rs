...
pub mod lifecycle {
    ...
    pub use super::super::agent_task_lifecycle::{
        ...
        fail_detached_cook_handoff_parent_in_store,
        fail_unmaterialized_cook_replay_claim_after_worker_exit, has_accepted_runner_handoff,
        ...
        rearm_quarantined_run_in_store, reconcile_record_health_in_store,
        reconcile_scope_run_ids_in_store, reconcile_status, reconcile_status_in_store,
        reconcile_status_with_options, record_acceptance_verdict_with_feedback_in_store,
        record_claimed_detached_cook_handoff_supervision_in_store, record_cook_attempt_in_store,
        ...
        record_pre_execution_failure_in_store, record_unmaterialized_cook_admission_in_store,
...
pub mod provider {
    ...
    pub use crate::agent_task_provider::{
        ...
        provider_runtime_readiness_cache_identity_for_plan, provider_secret_env_scopes,
        provider_secret_sources_for_providers, required_extension_ids_for_plan,
        resolve_provider_for_backend, validate_provider_runner_readiness_for_backend_with_catalog,
        AgentTaskExecutorProvider, AgentTaskProviderCatalog,
        AgentTaskProviderDependencyFailurePattern, AgentTaskProviderEnvPathReadiness,
        AgentTaskProviderRunnerReadiness, AgentTaskProviderRunnerReadinessContract,
        AgentTaskProviderRunnerSource, ExtensionProviderAgentTaskExecutor,
