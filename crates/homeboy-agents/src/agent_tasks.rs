...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        cook_index_exists_in_store, cook_index_in_store, cook_terminal_notification_outcome,
        durable_local_read, durable_local_read_in_store, exact_durable_local_read_in_store,
        ...
        reconcile_record_health, reconcile_terminal_artifact_projection,
        record_acceptance_verdict_with_feedback_in_store, record_completed_run,
        record_cook_attempt, record_cook_finalization,
