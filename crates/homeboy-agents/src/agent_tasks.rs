...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        logs, mark_resuming, mark_running, materialize_recovered_patch_artifact, persisted_status,
        ...
        reconcile_terminal_artifact_projection, record_acceptance_verdict_with_feedback,
        ...
        runner_diagnostic_probe, runner_pinned_runtime_for_mutation, runner_probe_plan,
        select_cook_candidate_from_attempts, status, status_with_options, submit_plan,
        ...
        AgentTaskRunTask, AgentTaskRunnerDiagnosticProbe, AgentTaskRunnerProbe,
