...
pub mod service {
    ...
    pub use super::super::agent_task_service::{
        ...
        resume_cook_batch, run_cook, run_cook_batch, run_cook_batch_with_control, run_loaded_plan,
        run_next, run_next_with_cook_dispatcher, run_submitted, run_submitted_with_timeout,
        run_terminal_cook_continuation, source_worktree_path, submit_plan_spec,
