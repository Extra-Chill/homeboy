...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        read_plan, reconcile_terminal_artifact_projection, resume, resume_cook_batch, retry,
        ...
        submit_plan_spec, AgentTaskCandidateAdoptionOptions, AgentTaskCookAttemptReport,
