...
pub mod service {
    pub use super::super::agent_task_service::{
        ...
        persist_provider_boundary_replay_evidence, promotion_is_resumable, promotion_source,
        read_plan, reconcile_terminal_artifact_projection, reconstruct_options_with_dispatcher,
        recover_cook_pr, recover_terminal_transport_proxy_evidence, register_promotion_job_driver,
        resume, resume_cook_batch, retry, run_cook, run_cook_batch, run_cook_with_durable_observer,
        ...
        submit_promotion_job, terminal_transport_recovery_required,
        ...
        AgentTaskPromotionJob, AgentTaskPromotionJobSubmission, AgentTaskPromotionRequest,
