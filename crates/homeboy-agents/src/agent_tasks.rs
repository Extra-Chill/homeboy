...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        record_runner_job_identity, retry, run_id_for_aggregate_path, run_record_exists,
        run_status, status, submit_plan, verified_controller_artifact_projection_path,
