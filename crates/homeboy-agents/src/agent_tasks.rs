...
pub mod lifecycle {
    pub use super::super::agent_task_lifecycle::{
        ...
        reserve_detached_cook_handoff_materialization, resolve_promotion_patch_artifact_id, retry,
        run_id_for_aggregate_path, run_record_exists, run_record_exists_readonly,
        ...
        AgentTaskDurableReadUnavailable, AgentTaskEventEnvelope, AgentTaskLifecycleStore,
        ...
        ControllerRuntimePruneResult, DetachedLabRunRecord, LabOffloadProxyPlan,
        RunnerPinnedRuntime, RUNNER_PROBE_SKIPPED_CALLER_OPTED_OUT,
