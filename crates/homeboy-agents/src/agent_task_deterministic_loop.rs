...
use homeboy_core::deterministic_loop::{
...
pub fn agent_task_loop_spec(
    definition: &AgentTaskLoopDefinition,
    max_iterations: u32,
) -> Result<homeboy_core::deterministic_loop::DeterministicLoopSpec> {
    if max_iterations == 0 {
    ...
    Ok(homeboy_core::deterministic_loop::DeterministicLoopSpec {
        ...
        ..homeboy_core::deterministic_loop::DeterministicLoopSpec::default()
    })
}
...
mod tests {
    ...
    use crate::agent_task_schedule::AgentTaskExecutionContext;
    use homeboy_core::deterministic_loop::{run_deterministic_loop, DeterministicLoopRunIdentity};
