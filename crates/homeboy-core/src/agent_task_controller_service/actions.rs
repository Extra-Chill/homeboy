...
fn controller_runner_availability(runner_id: &str) -> AgentTaskLoopRunnerAvailability {
    super::runner_availability::controller_runner_availability(runner_id)
}
...
fn persist_controller_artifacts(loop_id: &str, action_id: &str, artifacts: &Value) -> Result<()> {
    ...
    let root = crate::paths::artifact_root()?
...
pub(super) fn run_command_gate_check(
    check: &crate::agent_task_loop_controller::AgentTaskGateBundleCheck,
