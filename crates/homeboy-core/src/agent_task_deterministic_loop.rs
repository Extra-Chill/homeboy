...
pub fn agent_task_loop_spec(
    definition: &AgentTaskLoopDefinition,
    max_iterations: u32,
) -> Result<crate::deterministic_loop::DeterministicLoopSpec> {
    if max_iterations == 0 {
    ...
    Ok(crate::deterministic_loop::DeterministicLoopSpec {
        ...
        ..crate::deterministic_loop::DeterministicLoopSpec::default()
    })
}
...
mod tests {
    ...
    use crate::deterministic_loop::{run_deterministic_loop, DeterministicLoopRunIdentity};
