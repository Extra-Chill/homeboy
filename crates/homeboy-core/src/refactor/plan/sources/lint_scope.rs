...
fn lint_autofix_diff(root: &Path, changed_files: &[String]) -> crate::Result<String> {
...
pub(super) fn lint_finding_scope_files(findings: &[crate::finding::HomeboyFinding]) -> Vec<String> {
...
"#;
    ...
    fn lint_finding_scope_files_normalizes_reported_files() {
        let findings = vec![
            crate::finding::HomeboyFinding::builder("lint", "message")
                .file("src/b.php")
                .build(),
            crate::finding::HomeboyFinding::builder("lint", "message")
                .file("./src/a.php")
            ...
            crate::finding::HomeboyFinding::builder("lint", "message")
                .file("../outside.php")
                .build(),
            crate::finding::HomeboyFinding::builder("lint", "message").build(),
        ];
