...
pub(crate) fn generate_near_duplicate_fixes(
    ...
    for (fn_name, members) in &groups {
        ...
        // e.g., "src/core/code_audit/baseline.rs" → "crate::code_audit::baseline"
...
/// like "crate::code_audit::baseline".
...
mod tests {
    ...
    fn build_visibility_upgrade_private_fn() {
        let index = ModuleSurfaceIndex::from_surfaces(vec![
            crate::refactor::plan::generate::module_surface::ModuleSurface {
                ...
                symbols: HashMap::from([(
                    ...
                    crate::refactor::plan::generate::module_surface::SymbolSurface {
