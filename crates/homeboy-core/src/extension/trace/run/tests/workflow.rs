...
fn trace_failure_records_child_cleanup_context() {
    ...
    let output = RunnerOutput {
        ...
        timed_out: false,
        child_resource: Some(crate::engine::resource::ExtensionChildResourceSummary {
            ...
            duration_ms: 1000,
            peak: crate::engine::resource::ChildResourcePeakSample {
    ...
    let results = TraceResults {
        ...
        evidence: None,
        preview: None,
        timeline: vec![crate::observation::timeline::ObservationEvent {
            t_ms: 250,
