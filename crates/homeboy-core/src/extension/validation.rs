...
pub fn validate_required_extensions(component: &crate::component::Component) -> Result<()> {
    ...
    let mut missing: Vec<(&String, &crate::component::ScopedExtensionConfig)> = Vec::new();
...
fn extension_install_hint(
    extension_id: &str,
    ext_config: &crate::component::ScopedExtensionConfig,
) -> String {
...
fn extension_source(ext_config: &crate::component::ScopedExtensionConfig) -> Option<&str> {
