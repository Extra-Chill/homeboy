...
pub fn fix_to_edit_ops(fix: &crate::refactor::auto::Fix) -> Vec<TaggedEditOp> {
    fix.insertions
        .iter()
...
pub fn new_file_to_edit_op(nf: &crate::refactor::auto::NewFile) -> TaggedEditOp {
    TaggedEditOp {
...
pub fn fix_result_to_edit_ops(result: &crate::refactor::auto::FixResult) -> Vec<TaggedEditOp> {
...
pub fn propagate_edit_to_edit_op(edit: &crate::refactor::propagate::PropagateEdit) -> TaggedEditOp {
    TaggedEditOp {
...
pub fn propagate_result_to_edit_ops(
    result: &crate::refactor::propagate::PropagateResult,
) -> Vec<TaggedEditOp> {
    result.edits.iter().map(propagate_edit_to_edit_op).collect()
}

/// Translate a `TransformMatch` into a `TaggedEditOp`.
pub fn transform_match_to_edit_op(m: &crate::refactor::transform::TransformMatch) -> TaggedEditOp {
    TaggedEditOp {
...
pub fn transform_result_to_edit_ops(
    result: &crate::refactor::transform::TransformResult,
) -> Vec<TaggedEditOp> {
    result
        .rules
        .iter()
