...
use crate::agent_task_dispatch_service::AgentTaskDispatchCommand;
...
type AgentTaskDispatchResolver = fn(&[String]) -> crate::Result<Option<AgentTaskDispatchCommand>>;
...
pub fn resolve_agent_task_dispatch(
    argv: &[String],
) -> crate::Result<Option<AgentTaskDispatchCommand>> {
    let resolver = {
