...
mod tests {
    ...
    fn failed_extension_parity_ensure_records_the_planned_step() {
        with_isolated_home(|_| {
            ...
            let runner = crate::runner::load("homeboy-lab").expect("runner trail");
    ...
    fn extension_ready_validation_does_not_mutate_runner_state() {
        with_isolated_home(|home| {
            ...
            let mut runner = crate::runner::load("homeboy-lab").expect("runner");
            runner.settings.homeboy_path = Some(command.display().to_string());
            let resources_before = runner.resources.clone();
            ...
            let after = crate::runner::load("homeboy-lab").expect("runner after validation");
    ...
    fn revision_parity_accepts_matching_dev_overlay_content_hash() {
        ...
        let hash =
            crate::runner::extension_source_content_hash(tempdir.path()).expect("content hash");
    ...
    fn revision_parity_uses_latest_duplicate_dev_overlay_record() {
        ...
        let stale_hash =
            crate::runner::extension_source_content_hash(stale_dir.path()).expect("stale hash");
        ...
        let current_hash =
            crate::runner::extension_source_content_hash(current_dir.path()).expect("current hash");
    ...
    fn revision_parity_rejects_dirty_dev_overlay_when_same_revision_content_changed() {
        with_isolated_home(|home| {
            ...
            let synced_hash =
                crate::runner::extension_source_content_hash(source.path()).expect("content hash");
    ...
    fn materialized_overlay_record_replaces_duplicate_dev_sync_entries() {
        with_isolated_home(|_| {
            ...
            record_materialized_extension_overlay(
                "homeboy-lab",
                crate::runner::extension_materialization::RunnerExtensionMaterializationProvenance {
                    id: "nodejs".to_string(),
                    ...
                    dev_overlay: true,
                    lifecycle: crate::runner::extension_materialization::dev_extension_lifecycle(
                        "homeboy-lab",
            ...
            let runner = crate::runner::load("homeboy-lab").expect("load runner");
    ...
    fn parity_auto_sync_reports_controller_metadata_when_required_for_runner_job() {
        let source_error = crate::error::Error::validation_invalid_argument(
            "extension_id",
