...
use crate::api_jobs::{Job, JobEvent, JobStatus, RunnerJobLifecycleMetadata};
use crate::engine::command::CommandCaptureMetadata;
use crate::error::{Error, ErrorCode, Result};
use crate::lab_contract::{run_location_index_path, RunnerWorkload};
use crate::redaction::redact_argv;
use crate::runner::agent_task_lifecycle_event::agent_task_run_plan_lifecycle_event_from_workload_result;
...
pub(super) fn detached_handoff_output(
    ...
    runner_result
        .artifact_refs
        .push(crate::runner::RunnerArtifactRef {
