...
pub(in crate::runner) struct LabAtFileSpec {
    pub(in crate::runner) original_spec: String,
    pub(in crate::runner) local_path: PathBuf,
    pub(in crate::runner) remote_spec: String,
    pub(in crate::runner) remote_path: String,
}

pub(in crate::runner) fn lab_at_file_specs(
    args: &[String],
    source_path: &Path,
    remote_cwd: &str,
...
pub(in crate::runner) fn remap_lab_at_file_args(
    args: &[String],
    specs: &[LabAtFileSpec],
) -> Vec<String> {
    if specs.is_empty() {
