...
use crate::{git, worktree, worktree_providers};
use crate::{Error, Result};

use super::path_remap::{remap_local_path, LabPathRemap};
use super::EXPLICIT_PASSTHROUGH_SENTINEL;

pub(in crate::runner) fn lab_offload_source_path(args: &[String]) -> Result<PathBuf> {
...
pub(in crate::runner) fn rewrite_lab_offload_args(
    args: &[String],
    remote_path: &str,
...
pub(in crate::runner) fn rewrite_runner_resident_lab_offload_args(
    args: &[String],
    remote_output_file: Option<&str>,
) -> Vec<String> {
