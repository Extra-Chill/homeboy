...
mod lab_source_path_tests {
    ...
    fn lab_source_path_uses_provider_managed_cook_target_without_adopting_it() {
        crate::test_support::with_isolated_home(|_| {
            ...
            let record_path = crate::paths::homeboy_data()
                .expect("homeboy data")
...
mod provider_config_remap_tests {
    ...
    fn remap_provider_config_uses_typed_materialization_plan_projection() {
        let plan = crate::runner_execution_envelope::PathMaterializationPlan::new(vec![
            crate::runner_execution_envelope::PathMaterializationEntry::primary_workspace_materialized(
                crate::runner_execution_envelope::PATH_MATERIALIZATION_OWNER_LAB_PROVIDER_CONFIG,
