...
pub(in crate::runner) fn preflight_provider_config_paths_materialized_in_args(
    args: &[String],
...
pub(in crate::runner) fn provider_config_runtime_manifest(args: &[String]) -> Value {
    let envelope = ExecutionEnvelope::from_args(args);
...
pub(in crate::runner) fn remap_provider_config_in_args(
    args: &[String],
    mappings: &[LabPathRemap],
) -> Result<Vec<String>> {
    let envelope = ExecutionEnvelope::from_args(args);
...
pub(in crate::runner) fn remap_provider_config_with_materialization_plan_in_args(
    args: &[String],
...
pub(in crate::runner) fn inject_agent_task_default_provider_config_in_args(
    args: &[String],
) -> Result<Vec<String>> {
    let envelope = ExecutionEnvelope::from_args(args);
...
pub(in crate::runner) fn inject_agent_task_resolved_provider_policy_in_args(
    args: &[String],
) -> Result<Vec<String>> {
    ...
    let dispatch: AgentTaskDispatchCommand = match crate::runner::resolve_agent_task_dispatch(args)?
    {
