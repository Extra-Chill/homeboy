...
use crate::rig::spec::DependencyCacheSpec;
...
mod tests {
    ...
    fn materialized_git_dependency_preserves_canonical_git_provenance() {
        ...
        crate::test_support::with_isolated_home(|_| {
            ...
            let runner = crate::runner::load("lab-local-git-dependency").expect("load runner");
    ...
    fn dependency_cache_key_changes_with_declared_inputs() {
        ...
        let spec = crate::rig::spec::DependencyCacheSpec {
