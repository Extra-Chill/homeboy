...
pub(super) struct RigComponentDependency {
    ...
    pub dependency_cache: Option<crate::rig::spec::DependencyCacheSpec>,
}
...
fn rig_component_env_overrides(
    ...
    vec![
        (
            crate::rig::expand::rig_component_path_override_env_name(
                &dependency.rig_id,
        ...
        (
            crate::rig::expand::rig_component_checkout_root_override_env_name(
                &dependency.rig_id,
                &dependency.component_id,
            ),
...
fn normalize_path_for_prefix(path: &Path) -> PathBuf {
    crate::paths::normalize_local_path(path)
}
...
mod tests {
    ...
    fn collects_rig_component_dependency_checkout_roots() {
        crate::test_support::with_isolated_home(|home| {
            ...
            let rig_dir = crate::paths::rigs().expect("rig dir");
    ...
    fn expands_package_root_for_remote_component_dependency_root() {
        crate::test_support::with_isolated_home(|home| {
            ...
            .expect("save rig");
            std::fs::create_dir_all(crate::paths::rig_sources().expect("rig sources"))
                .expect("create rig sources");
            crate::rig::install::write_source_metadata(
                "studio-web-product-matrix",
                &crate::rig::install::RigSourceMetadata {
