...
use crate::api_jobs::{JobArtifactMetadata, JobEvent, JobEventKind};
use crate::runner::{
...
fn reverse_worker_result_preserves_exec_patch_and_artifacts() {
    let result = remote_runner_result_from_exec_output(
        RunnerExecOutput {
            ...
            mutation_artifacts: Some(crate::runner::RunnerMutationArtifacts {
                patch_ref: Some(crate::runner::RunnerArtifactRef {
