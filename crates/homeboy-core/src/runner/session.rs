...
use crate::api_jobs::{ActiveRunnerJobSummary, Job, JobArtifactMetadata, JobStatus};
...
pub struct RunnerJob {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub lifecycle: Option<crate::api_jobs::RunnerJobLifecycleMetadata>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(flatten)]
    pub claim: crate::api_jobs::JobClaimMetadata,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
impl From<&ActiveRunnerJobSummary> for RunnerJob {
    fn from(job: &ActiveRunnerJobSummary) -> Self {
        Self {
            ...
            lifecycle_owner: match crate::api_jobs::RunnerJobSource::from_metadata(&job.source)
                .lifecycle_owner()
            {
                crate::api_jobs::RunnerJobLifecycleOwner::Broker => RunnerLifecycleOwner::Broker,
                crate::api_jobs::RunnerJobLifecycleOwner::Controller => {
...
impl RunnerJob {
    pub fn from_job(
        ...
        Self {
            ...
            claim: crate::api_jobs::JobClaimMetadata {
