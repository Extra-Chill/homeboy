...
use crate::gate::{collect_plan_gate_results, HomeboyGateResult};
use crate::lab_contract::RunnerWorkload;
use crate::plan::{HomeboyPlan, PlanStepStatus};
use crate::proof::{HomeboyProof, HomeboyProofProvenance, HomeboyProofRunner};
...
mod tests {
    ...
    use crate::proof::{HomeboyProof, HomeboyProofProvenance};
    ...
    fn lab_offload_metadata_records_runner_workload_when_supplied() {
        ...
        let workload = RunnerWorkload {
            ...
            required_secrets: RunnerWorkloadSecrets {
                categories: Vec::new(),
                secret_env_plan: crate::secret_env_plan::SecretEnvPlan::default(),
            },
