...
use crate::api_jobs::{Job, JobArtifactMetadata, JobEvent, JobEventKind, JobStatus};
use crate::observation::{ArtifactRecord, ObservationStore, RunRecord};
use crate::runner::{Runner, RunnerKind};
...
fn test_mirror_daemon_evidence_persists_runner_exec_observation() {
    crate::test_support::with_isolated_home(|_| {
        ...
        let run = mirror_job_run(
            ...
            None,
            Some(
                &crate::notification_route::NotificationRoute::new(
                    "extension",
                    "opaque-origin-route",
                )
                .expect("route"),
...
fn mirroring_lab_job_preserves_agent_task_lifecycle_metadata() {
    crate::test_support::with_isolated_home(|_| {
        ...
        let lifecycle = crate::agent_task_lifecycle::status("agent-task-lab-mirror")
