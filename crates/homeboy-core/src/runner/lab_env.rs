...
use crate::observation::{LAB_OFFLOAD_METADATA_ENV, PREVIEW_METADATA_ENV, PREVIEW_PUBLIC_URL_ENV};
...
mod tests {
    use super::*;
    use crate::runner::lab_workspaces::workspace_mapping_entry;
    use crate::runner::{RunnerWorkspaceSyncMode, RunnerWorkspaceSyncOutput};
    use std::sync::Mutex;
            ...
            &RunnerWorkspaceSyncOutput {
                ...
                materialization_plan:
                    crate::runner::RunnerWorkspaceMaterializationPlan::from_test_parts(
                        ...
                        crate::runner::RunnerWorkspaceSyncMode::Snapshot,
                        "snapshot",
                    ),
                current_workspace: crate::runner::RunnerWorkspaceCurrentSummary {
                    local_path: "/Users/user/Developer/example-component".to_string(),
                    remote_path: "/home/user/Developer/example-component".to_string(),
                    sync_mode: crate::runner::RunnerWorkspaceSyncMode::Snapshot,
                    materialized: true,
                    source_commit: None,
                    source_ref: None,
                    source_dirty: None,
                ...
                counts: crate::runner::ByteFileCounts { files: 1, bytes: 1 },
                excludes: Vec::new(),
                includes: Vec::new(),
    ...
    fn declared_dependency_paths_env_exports_validation_dependency_mapping() {
        let mapping = vec![
            crate::runner::lab_workspaces::workspace_mapping_entry_for_validation_dependency(
                &crate::runner::RunnerValidationDependencySyncOutput {
