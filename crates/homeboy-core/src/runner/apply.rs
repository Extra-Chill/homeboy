    ...
    match serde_json::from_str(&contents) {
        ...
        Err(contract_error) => {
            ...
            Ok(LabPatchApplyInput {
                artifact: ChangeArtifact {
                    schema: crate::change_artifact::CHANGE_ARTIFACT_SCHEMA.to_string(),
...
mod tests {
    ...
    fn output_serializes_flat_apply_result_with_artifact_summary() {
        ...
        fs::write(
            &input,
            serde_json::json!({
                "schema": crate::change_artifact::CHANGE_ARTIFACT_SCHEMA,
                "source_snapshot": snapshot,
                "provenance": {
