...
use crate::agent_tasks::scheduler::{AgentTaskAggregate, AgentTaskAggregateTotals, AgentTaskPlan};
use crate::api_jobs::JobEvent;
#[cfg(test)]
    ...
    fn typed_run_plan_lifecycle_preserves_completed_noop_and_remote_evidence() {
        crate::test_support::with_isolated_home(|_| {
            ...
            assert_eq!(
                ...
                crate::agent_task::AgentTaskOutcomeStatus::NoOp
            );
    ...
    fn typed_run_plan_lifecycle_persists_remapped_provider_model_for_publication() {
        crate::test_support::with_isolated_home(|_| {
            ...
            let plan = AgentTaskPlan::new(
                "plan-remapped-model",
                vec![crate::agent_task::AgentTaskRequest {
