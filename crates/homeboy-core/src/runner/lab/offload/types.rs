...
pub struct LabOffloadCommand {
    pub command: crate::lab_contract::LabCommandContract,
    pub required_extensions: Vec<String>,
    pub required_capabilities: Vec<crate::lab_contract::RunnerWorkloadCapability>,
    pub workload: Option<crate::lab_contract::LabRigWorkloadArguments>,
}

impl std::ops::Deref for LabOffloadCommand {
    type Target = crate::lab_contract::LabCommandContract;
...
pub type LabOffloadSourcePathMode = crate::lab_contract::LabSourcePathMode;
pub type LabOffloadWorkspaceModePolicy = crate::lab_contract::LabWorkspaceModePolicy;
