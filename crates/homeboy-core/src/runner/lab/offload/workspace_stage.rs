...
fn preflight_agent_task_secret_env_before_workspace_stage(
    ...
    if !contract
        .secret_env_sources
        .contains(&crate::lab_contract::LabSecretEnvSource::AgentTask)
    {
        return Ok(());
    }
    ...
    fn for_offload(
        ...
        if let Some(workload) = workload {
            ...
            let command = match workload.kind {
                crate::lab_contract::LabRigWorkloadKind::Bench => rig::RigWorkloadKind::Bench,
                crate::lab_contract::LabRigWorkloadKind::Fuzz => rig::RigWorkloadKind::Fuzz,
            };
...
mod tests {
    ...
    fn rig_workload(
        kind: crate::lab_contract::LabRigWorkloadKind,
        rig_id: &str,
        component: Option<&str>,
    ) -> crate::lab_contract::LabRigWorkloadArguments {
        crate::lab_contract::LabRigWorkloadArguments {
            kind,
    ...
    fn runner_command_plan_for_primary_fuzz_rig_adds_workload_and_component_extensions() {
        crate::test_support::with_isolated_home(|home| {
            ...
            let workload = rig_workload(
                crate::lab_contract::LabRigWorkloadKind::Fuzz,
    ...
    fn runner_command_plan_preserves_explicit_override_without_a_rig() {
        let workload = crate::lab_contract::LabRigWorkloadArguments {
            kind: crate::lab_contract::LabRigWorkloadKind::Fuzz,
            rig_ids: Vec::new(),
            component: None,
    ...
    fn provider_config_materialization_plan_projects_lab_policy_and_mappings() {
        ...
        let contract = LabOffloadCommand {
            command: crate::lab_contract::LabCommandContract {
                workspace_mode_policy: LabOffloadWorkspaceModePolicy::GitCheckoutRequired,
                ..crate::lab_contract::LabCommandContract::portable(
                    "agent-task.run",
                    None,
                    false,
                    &[],
    ...
    fn test_lab_contract_with_agent_task_secrets() -> LabOffloadCommand {
        LabOffloadCommand {
            command: crate::lab_contract::LabCommandContract {
                workspace_mode_policy: LabOffloadWorkspaceModePolicy::GitCheckoutRequired,
                secret_env_sources: &[crate::lab_contract::LabSecretEnvSource::AgentTask],
                ..crate::lab_contract::LabCommandContract::portable(
                    "agent-task.run",
                    None,
                    false,
    ...
    fn test_runner() -> crate::runner::Runner {
        crate::runner::Runner {
            id: "lab".to_string(),
            ...
            policy: crate::server::RunnerPolicy::default(),
        }
    }
    ...
    fn retry_stage_routes_changed_since_private_source_through_controller_bundle() {
        crate::test_support::with_isolated_home(|_| {
            ...
            let contract = LabOffloadCommand {
                command: crate::lab_contract::LabCommandContract {
                    workspace_mode_policy: LabOffloadWorkspaceModePolicy::GitCheckoutRequired,
                    ..crate::lab_contract::LabCommandContract::portable("audit", None, false, &[])
                },
                required_extensions: Vec::new(),
                required_capabilities: Vec::new(),
                workload: None,
            ...
            let stage = prepare_lab_offload_workspace_stage(
                &request,
                &contract,
                crate::runner::lab_plan::base_lab_plan(Some(&contract)),
    ...
    fn managed_worktree_staging_preserves_cook_attempt_identity_through_daemon_acceptance() {
        crate::test_support::with_isolated_home(|_| {
            ...
            let accepted = crate::agent_task_lifecycle::record_detached_lab_run(
