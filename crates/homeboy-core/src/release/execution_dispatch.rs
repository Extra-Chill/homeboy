...
fn run_dependencies_preflight(
    ...
    match crate::deps::install_for_resolved(context.component, component_path) {
...
mod tests {
    ...
    use crate::component::{Component, ComponentScriptsConfig, VersionTarget};
    use crate::extension::ExtensionManifest;
    ...
    fn extension_declared_release_preflight_executes_action() {
        crate::test_support::with_isolated_home(|_| {
            let temp = tempfile::tempdir().expect("tempdir");
            let mut extension: crate::extension::ExtensionManifest =
