...
pub fn read_json_file_with<T, E>(
    path: &Path,
...
pub fn read_optional_json_file_with<T, E>(
    path: &Path,
    map_read_error: impl FnOnce(std::io::Error) -> E,
    map_parse_error: impl FnOnce(serde_json::Error, String) -> E,
...
pub fn read_json_value_spec_with_bare_path(spec: &str, context: &str) -> Result<serde_json::Value> {
