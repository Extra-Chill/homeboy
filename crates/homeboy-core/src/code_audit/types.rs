...
/// [`PhaseTimer`](crate::phase_timing::PhaseTimer) primitive.
///
...
impl From<crate::phase_timing::PhaseSpan> for AuditTimingSpan {
    fn from(span: crate::phase_timing::PhaseSpan) -> Self {
        AuditTimingSpan {
            id: span.id,
...
impl AuditTiming {
    ...
    /// [`PhaseTimer`](crate::phase_timing::PhaseTimer).
    ...
    fn extend_from_timer(&mut self, timer: crate::phase_timing::PhaseTimer) {
        self.spans.extend(
            timer
                .into_report()
                .spans
