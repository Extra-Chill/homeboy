...
pub use json_io::{
    ...
    to_string_pretty, try_read_json_file, BulkIdsInput,
};
...
pub use json_pointer::{config_pointer, get_json_pointer, remove_json_pointer, set_json_pointer};
    ...
    impl ConfigEntity for TestEntity {
        ...
        fn not_found_error(id: String, suggestions: Vec<String>) -> Error {
            Error::entity_not_found(
                crate::error::ErrorCode::ConfigMissingKey,
                "Test",
                id,
                suggestions,
            )
