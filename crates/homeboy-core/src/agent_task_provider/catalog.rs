...
impl ExtensionProviderAgentTaskExecutor {
    ...
    pub fn default_backend(&self) -> crate::Result<Option<String>> {
...
pub fn default_backend() -> crate::Result<Option<String>> {
    default_backend_from_policy(None)
}

pub fn default_backend_for_component(component_id: Option<&str>) -> crate::Result<Option<String>> {
...
pub fn enforce_runtime_preflight_checks_for_plan(plan: &AgentTaskPlan) -> crate::Result<()> {
...
fn default_backend_from_policy(component_id: Option<&str>) -> crate::Result<Option<String>> {
