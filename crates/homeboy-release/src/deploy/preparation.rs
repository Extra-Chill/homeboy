...
impl ComponentPayloadPreparationRequest {
    pub fn new(component: &Component, config: &DeployConfig) -> Self {
        Self {
            component: ComponentPayloadPreparationSource {
                ...
                package_artifacts: component.package_artifacts.clone(),
    ...
    fn component(&self) -> Component {
        Component {
            ...
            package_artifacts: self.component.package_artifacts.clone(),
...
impl GeneratedSourceArtifactCleanup {
    fn new(component: &Component) -> Result<Self> {
        ...
        let build_dir = Path::new(&component.local_path)
            .join(homeboy_core::defaults::deploy_generated_build_dir());
...
mod tests {
    ...
    fn binding_only_overrides_share_a_preparation_request() {
        ...
        let config = config();
        let first_project = homeboy_core::project::Project {
            id: "first".to_string(),
            component_overrides: [(
                "fixture".to_string(),
        ...
        let second_project = homeboy_core::project::Project {
            id: "second".to_string(),
            component_overrides: [(
                "fixture".to_string(),
                homeboy_core::project::ProjectComponentOverrides {
        ...
        let (first_preparation, first_binding) =
            homeboy_core::project::component::overrides::resolve_deploy_override_inputs(
                &source,
                &first_project,
            );
