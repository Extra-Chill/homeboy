...
//!
//! - Bot identity and commit prefix: [`homeboy_core::git`] / [`super::guard`].
//! - Drift-file classification: [`homeboy_core::component::drift`].
//! - Git primitives: [`homeboy_core::git`] (`stage_all`, `commit_*`, `run_git`).
//!
...
pub fn run_autofix_transaction(request: TransactionRequest<'_>) -> Result<TransactionOutcome> {
    ...
    let drift_files = homeboy_core::component::drift::drift_file_paths(request.component);
