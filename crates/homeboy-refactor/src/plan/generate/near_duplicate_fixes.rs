...
use crate::auto::{Fix, Insertion, RefactorPrimitive, SkippedFile};
...
pub(crate) fn generate_near_duplicate_fixes(
    ...
    for (fn_name, members) in &groups {
        ...
        // e.g., "src/core/code_audit/baseline.rs" → "homeboy_code_audit::baseline"
...
mod tests {
    ...
    fn build_visibility_upgrade_private_fn() {
        let index = ModuleSurfaceIndex::from_surfaces(vec![
            crate::plan::generate::module_surface::ModuleSurface {
                ...
                symbols: HashMap::from([(
                    ...
                    crate::plan::generate::module_surface::SymbolSurface {
