...
macro_rules! builtin_json_command_descriptors {
    ($consumer:ident) => {
        $consumer! {
            ...
            (Observe, $crate::commands::observe::run, command_spec("observe", CommandJsonFamily::Quality)),
            ...
            (Report, $crate::commands::report::run, command_spec("report", CommandJsonFamily::Workspace)),
            ...
            (Runs, $crate::commands::runs::run, CommandSpec { subcommand_safety: RUNS_SUBCOMMAND_SAFETY, ..command_spec_with_output_notes("runs", CommandJsonFamily::Workspace, "inspects persisted evidence, artifacts, artifact postprocessing, and finding reconciliation workflows") }),
