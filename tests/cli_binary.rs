#[path = "cli_binary/agent_task_provider_flag_diagnostic.rs"]
...
mod output_errors;
#[path = "cli_binary/product_identity_test.rs"]
mod product_identity_test;
#[path = "cli_binary/promotion_provider_stdin.rs"]
