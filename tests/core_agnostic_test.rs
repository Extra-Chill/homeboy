...
const TEST_CONTENT_BASELINE_OCCURRENCES: usize = 66;
...
mod agnostic_enforcement {
    ...
    fn core_owned_source_stays_language_and_framework_agnostic() {
        ...
        let baseline_fingerprints =
            homeboy::core::code_audit::baseline::policy_baseline_fingerprints(
        ...
        let new_policy_findings = if baseline_mode
            == homeboy::core::code_audit::baseline::PolicyBaselineMode::ChangedScope
        {
            Vec::new()
        } else {
