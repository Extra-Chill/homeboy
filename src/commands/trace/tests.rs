...
use super::test_fixture::{
    ...
    write_trace_rig, write_trace_rig_with_phase_preset, write_trace_rig_with_phase_template,
    write_trace_rig_with_port_range, write_trace_rig_with_span_metadata,
