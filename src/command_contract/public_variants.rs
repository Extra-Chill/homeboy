...
pub const PUBLIC_OUTPUT_VARIANT_CONTRACTS: &[PublicOutputVariantContract] = &[
    ...
    PublicOutputVariantContract {
        ...
        variant: "issue",
        discriminator_field: Some("variant"),
        discriminator_value: Some("issue"),
        golden_fixture: None,
    },
    PublicOutputVariantContract {
        command: "git",
    ...
    PublicOutputVariantContract {
        ...
        variant: "policy",
        discriminator_field: Some("variant"),
        discriminator_value: Some("policy"),
        golden_fixture: None,
    },
    PublicOutputVariantContract {
        command: "http",
    ...
    PublicOutputVariantContract {
        ...
        variant: "lifecycle",
        discriminator_field: Some("variant"),
        discriminator_value: Some("lifecycle"),
        golden_fixture: None,
    },
    PublicOutputVariantContract {
        command: "runner",
