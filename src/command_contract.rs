...
pub use lab::{
    ...
    LabSecretEnvSource, LabSelectedRunnerFallbackPolicy, LabSourcePathMode, LabWorkspaceModePolicy,
    RunLocationIndex, RunnerHandoffArtifactManifestRef, RunnerHandoffEnvelope,
    RunnerHandoffFollowCommands, RunnerWorkload, RunnerWorkloadAgentTask,
...
pub(crate) use spec::{
    ...
    RIG_CHECK_LAB_LABEL, RIG_RUN_LAB_LABEL, RIG_SOURCE_MANAGEMENT_LAB_LABEL, TEST_LAB_LABEL,
