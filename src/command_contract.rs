...
pub use lab::{
    ...
    LabLocalExecutionPolicy, LabLocalHotPolicy, LabRigWorkloadArguments, LabRigWorkloadKind,
    LabRoutingPolicy, LabRunnerSupportSummary, LabSecretEnvSource, LabSelectedRunnerFallbackPolicy,
