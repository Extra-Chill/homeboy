...
pub(crate) fn render_hierarchy(hierarchy: &[HierarchyEntry], class_index: &HashMap<String, String>) -> String {
    let mut out = String::new();
...
pub(crate) fn render_hooks_summary(summary: &HookSummary) -> String {
    let mut out = String::new();
