...
pub const FUZZ_ACTION_MODEL_SCHEMA: &str = "homeboy/fuzz-action-model/v1";
pub const FUZZ_EXPLORATION_POLICY_SCHEMA: &str = "homeboy/fuzz-exploration-policy/v1";
...
pub const FUZZ_SEQUENCE_PLAN_SCHEMA: &str = "homeboy/fuzz-sequence-plan/v1";
pub const FUZZ_SEQUENCE_RESULT_SCHEMA: &str = "homeboy/fuzz-sequence-result/v1";
...
pub const FUZZ_COVERAGE_RECONCILIATION_SCHEMA: &str = "homeboy/fuzz-coverage-reconciliation/v1";
