...
use super::schemas::{
    FUZZ_ACTION_MODEL_SCHEMA, FUZZ_ARTIFACT_SCHEMA, FUZZ_CAMPAIGN_SCHEMA, FUZZ_CASE_LOG_SCHEMA,
    FUZZ_CASE_SCHEMA, FUZZ_CONTRACT_VERSION, FUZZ_CORE_CONTRACT_SCHEMA,
    ...
    FUZZ_SAMPLING_REQUEST_SCHEMA, FUZZ_SEED_SCHEMA, FUZZ_SEQUENCE_PLAN_SCHEMA,
    FUZZ_SEQUENCE_RESULT_SCHEMA, FUZZ_SURFACE_SCHEMA, FUZZ_TARGET_INVENTORY_SCHEMA,
...
pub(super) fn fuzz_action_model_schema() -> String {
    FUZZ_ACTION_MODEL_SCHEMA.to_string()
}

pub(super) fn fuzz_exploration_policy_schema() -> String {
    FUZZ_EXPLORATION_POLICY_SCHEMA.to_string()
}
...
pub(super) fn fuzz_sequence_plan_schema() -> String {
    FUZZ_SEQUENCE_PLAN_SCHEMA.to_string()
}

pub(super) fn fuzz_sequence_result_schema() -> String {
    FUZZ_SEQUENCE_RESULT_SCHEMA.to_string()
}
...
pub(super) fn fuzz_coverage_reconciliation_schema() -> String {
    FUZZ_COVERAGE_RECONCILIATION_SCHEMA.to_string()
}
