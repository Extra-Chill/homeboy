...
mod tests {
    ...
    #[test]
    fn test_generate_unreferenced_export_fixes_let_some_symbol_surface_surface_symbol_surface_fn_name_else() {

        generate_unreferenced_export_fixes();
    }

    #[test]
    fn test_generate_unreferenced_export_fixes_ok_content_content() {
