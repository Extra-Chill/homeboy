...
pub use call_graph_analysis::{
    ...
    find_dominant_prefix,
    pick_cluster_label,
};
pub use constants::{
    HUB_THRESHOLD,
    MAX_GROUP_SIZE,
    MAX_MODULE_NAME_WORDS,
    MERGE_THRESHOLD,
    MIN_CLUSTER_SIZE,
};
pub use declaration::{starts_like_extractable_declaration, matches_declaration_prefix};
pub use export::{parse_items_for_group_export, export_name_for_item};
pub use group_refinement::{
    count_local_function_references,
    identify_parent_kept_functions,
    is_root_orchestrator_name,
    run_moves,
    split_oversized_group,
    validate_plan_sources,
};
pub use items::{dedupe_parsed_items, filter_extractable_items, group_items};
pub use merge_small::{merge_small_groups_protected, merge_small_groups};
pub use module::{is_module_root, is_effective_module_root};
pub use name_segment_clustering::{
    cluster_by_name_segments,
    is_stop_word,
    name_prefixes,
    name_segments,
};
pub use public::{is_public_item_source, public_items_for_group};
pub use remove_conflicting_use::{generate_source_module_index, remove_conflicting_use_imports};
pub use section_header_parsing::{
    extract_sections,
    find_section_for_item,
    sanitize_module_name,
    section_name_to_slug,
    truncate_module_name,
};
pub use source_test_file::{project_audit_impact, source_to_test_file};
pub use surface::{has_established_module_surface, rebalance_for_viable_parent_surface};
pub use type_co_location::{colocate_types, to_snake_case};
pub use types::{
