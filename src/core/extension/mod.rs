...
pub use manifest::{
    ...
    PackageNameSource, PlatformCapability, ProvidesConfig, ReleasePreflightConfig,
    ...
    SourceSnapshotConfig, StructuredSidecarDeclaration, TestChangedFileExclusiveEnv,
