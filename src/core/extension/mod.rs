...
pub use manifest::{
    ...
    FileContainsCondition, HttpMethod, IncludeWrapperPolicy, InputConfig, LintChangedFileRoute,
    LintConfig, OutputConfig, OutputSchema, PackageNameSource, PlatformCapability, ProvidesConfig,
    ...
    SinceTagConfig, StructuredSidecarDeclaration, TestChangedFileExclusiveEnv,
    TestChangedFileRouting, TestChangedFileRoutingStrategy, TestConfig, TestDriftConfig,
    TestMappingConfig, TestPassthroughFilter, TestPassthroughFilterStrategy, TestVacuityPolicy,
