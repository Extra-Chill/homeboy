...
pub fn available_port() -> crate::core::Result<u16> {
...
pub fn capture_artifact_entrypoints(
    ...
    port: Option<u16>,
) -> crate::core::Result<(String, CaptureProvider, Vec<CapturedPage>)> {
...
pub fn entrypoint_url(base_url: &str, entrypoint: &str) -> crate::core::Result<String> {
