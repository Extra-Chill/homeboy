...
pub use super::agent_task::{
    ...
    AgentTaskMatrixCell, AgentTaskMatrixError, AgentTaskMatrixPlan, AgentTaskOutcome,
    AgentTaskOutcomeStatus, AgentTaskPolicy, AgentTaskPreparedWorkspace, AgentTaskProgress,
    AgentTaskRequest, AgentTaskSourceRef, AgentTaskStart, AgentTaskWorkflowEvidence,
    AgentTaskWorkflowStepEvidence, AgentTaskWorkflowStepStatus, AgentTaskWorkflowStepSuggestion,
...
pub mod controller_service {
    pub use super::super::agent_task_controller_service::{
        ...
        ControllerPlanRequest, ControllerResumeOptions, ControllerResumeReport,
        MaterializeSpecSource, NoopDispatchHook, ACTION_RESULT_SCHEMA, APPLY_EVENT_RESULT_SCHEMA,
        FROM_SPEC_RESULT_SCHEMA, LIST_RESULT_SCHEMA, PLAN_RESULT_SCHEMA, RESUME_RESULT_SCHEMA,
    };
}
