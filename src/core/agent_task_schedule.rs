...
mod config {
    ...
    pub struct AgentTaskOutputBinding {
        ...
        #[serde(default = "defaults::default_required_output")]
        pub required: bool,
        #[serde(default, skip_serializing_if = "Value::is_null")]
        pub default: Value,
    }
    ...
    pub struct AgentTaskAdaptiveConcurrencyPolicy {
        #[serde(default = "defaults::default_adaptive_min_concurrency")]
    ...
    pub struct AgentTaskResourceBudget {
        ...
        #[serde(default = "defaults::default_task_resource_units")]
...
mod defaults {
    ...
    pub fn default_adaptive_min_concurrency() -> usize {
        1
    }

    pub fn default_task_resource_units() -> u32 {
        1
    }

    pub fn default_required_output() -> bool {
        true
    }
}
