...
use super::token::{runner_artifact_token, RemoteArtifactToken};
use super::util::{ms_to_rfc3339, push_unique_string, required_str};
...
pub(super) fn reverse_broker_artifact_record(
    runner: &Runner,
    broker_url: &str,
    run_id: &str,
    job: &Job,
    artifact: &crate::core::api_jobs::JobArtifactMetadata,
) -> ArtifactRecord {
    ArtifactRecord {
