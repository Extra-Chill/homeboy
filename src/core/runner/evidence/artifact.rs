//! Runner artifact path/token resolution and remote artifact download.
...
#[derive(Debug, Clone)]
pub(super) struct RemoteArtifactToken {
...
pub(super) fn runner_artifact_token(runner_id: &str, run_id: &str, artifact_id: &str) -> String {
    EXECUTION_CONTRACT
        .artifacts
